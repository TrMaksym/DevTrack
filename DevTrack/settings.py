...
from TaskTracker import context_processors
...
SECRET_KEY = 'django-insecure-@d9qsm#bxauwnb9^rexla3(mt$=^5lz@8*z+pm^ww1-h3*h0^&'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'TaskTracker.context_processors.cfg_assets_root',
            ],
        },
    },
]
